    ...
    if authentication
      ...
      if @user.save
        ...
        session[:omniauth] = omniauth.except('extra')
	      redirect_to new_user_session_url, notice: "Sorry, your Simple Church account is not linked to the service you chose. Sign in to link your accounts. If if you're not on Simple Church yet, request an invite!"
      end
    end
  end
